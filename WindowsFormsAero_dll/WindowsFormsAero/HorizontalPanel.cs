...
public class HorizontalPanel : Panel
{
	...
	/// </remarks>
	[Description("Gets or sets whether the control can render on an Aero glass surface.")]
	[Category("Appearance")]
	[DefaultValue(false)]
	...
	{
		base.OnPaint(e);
		Color color = Color.FromArgb(204, 217, 234);
	...
	protected override void WndProc(ref Message m)
	{
		...
		{
			RedrawControlAsBitmap(base.Handle);
		}
	}
}
